...
struct ProfileView: View {
    ...
    var hair=["Oblong": ["Blount Bob","Oblong1","Oblong2"],"Round":["Long Wavy Layers","Textured Lob","Round1"], "Heart": ["Bangs","Heart1","Heart2"], "Oval": ["Old Hollywood Waves", "Oval1", "Oval2"], "Square": ["Curly Bob", "Long and Voluminous","Tousled Lob"],"unknown":[],"":[]]
