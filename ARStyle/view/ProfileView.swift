...
struct ProfileView: View {
    ...
    var body: some View {
        ...
        VStack{
            ...
            Image(faceShape.lowercased())
            .resizable()
            .aspectRatio(contentMode: .fit)
            .frame(width: 350, height: 350, alignment: .top)
            Text("Face shape: \(faceShape)")
                .multilineTextAlignment(.center).padding(.horizontal, 15.0).foregroundColor(Color(red: 36 / 255, green: 64 / 255, blue: 61 / 255))
            ...
            ScrollView(.vertical){
                VStack{
                    Text("Suggested Hair Styles").bold().frame(alignment: .center)
                    ScrollView(){
                        HStack{
                        ...
                        Image(immagine)
                            ...
                            Section(header: Text("Suggested Beard")){
                                HStack{
        ...
        }.padding(.horizontal, 5.0).navigationTitle(Text("Profile")).navigationBarTitleDisplayMode(.inline).navigationBarItems(trailing: NavigationLink("Gallery",destination: GalleryView()))
